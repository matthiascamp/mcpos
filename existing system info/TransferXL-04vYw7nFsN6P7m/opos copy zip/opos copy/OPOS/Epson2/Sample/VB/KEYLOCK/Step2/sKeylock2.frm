...
Begin VB.Form Step2 
   ...
   Caption         =   "Step 2 Use the WaitForKeyLockChange method."
   ClientHeight    =   1695
   ClientLeft      =   3045
   ClientTop       =   3330
   ClientWidth     =   6210
   ...
   Begin OposKeylock_CCOCtl.OPOSKeylock OPOSKeylock1 
      Left            =   5160
      OleObjectBlob   =   "sKeylock2.frx":0000
      Top             =   720
   End
...
'Step 2 Use the WaitForKeyLockChange method.
Option Explicit
...
Private Sub Command1_Click()
    ...
    If OPOSKeylock1.WaitForKeylockChange(LOCK_KP_ANY, 5000) = OPOS_E_TIMEOUT Then
        MsgBox "The keylock position has not been changed in time. "
    End If
