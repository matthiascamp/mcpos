...
Begin VB.Form Step6 
   ...
   Caption         =   "Step 6 Changing reading mode."
   ClientHeight    =   3915
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   7080
   ...
   Begin OposCheckScanner_CCOCtl.OPOSCheckScanner OPOSCheckScanner1 
      Left            =   840
      OleObjectBlob   =   "sChkScan6.frx":0000
      Top             =   3360
   End
   Begin OposMICR_CCOCtl.OPOSMICR OPOSMICR1 
      Left            =   240
      OleObjectBlob   =   "sChkScan6.frx":0024
      Top             =   3360
   End
...
Private Sub Combo2_Click()
    ...
    With OPOSCheckScanner1
        ...
        Case CHK_IF_TIFF
            m_cscnPath = "\Step6.tif" 'case .tif
        Case CHK_IF_BMP
            m_cscnPath = "\Step6.bmp" 'case .bmp
        Case CHK_IF_JPEG
            m_cscnPath = "\Step6.jpg" 'case .jpg
        Case Else
            m_cscnPath = "\Step6.bmp" 'case .bmp
        End Select
...
Private Sub Command2_Click()
    ...
    With OPOSCheckScanner1
        ...
        'Set FileID
        .FileID = "Epson CheckScanner SampleProgram Step6"
    
        'Set FileID
        .ImageTagData = "Epson CheckScanner SampleProgram Step6 ImageTagData"
...
Private Sub Command5_Click()
    ...
    Dim strStep As String   '"Step2" or Step3" or "Step4" or "Step5" or "Step6"
