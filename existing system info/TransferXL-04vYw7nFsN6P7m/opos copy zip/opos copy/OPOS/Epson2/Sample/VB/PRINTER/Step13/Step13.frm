...
Begin VB.Form Step13 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Step 13 Obtains the statistics of the device."
   ClientHeight    =   6165
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5700
   ...
   Begin OposPOSPrinter_CCOCtl.OPOSPOSPrinter OPOSPOSPrinter1 
      Left            =   2280
      OleObjectBlob   =   "Step13.frx":0000
      Top             =   5520
   End
End
Attribute VB_Name = "Step13"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
' Step 13  Device Statistics.
...
' Make a data of the buying goods
    ...
    With OPOSPOSPrinter1
        ...
        'Print the total cost
            ...
            'Whether the barcode can be printed on receipt, or not.
            ...
            'Feed the receipt to the cut position.
...
Private Sub cmdReceipt_Click()
    ...
    Dim ZEINUKI As String
    Dim ZEI As String
    Dim SHAMEI As String
