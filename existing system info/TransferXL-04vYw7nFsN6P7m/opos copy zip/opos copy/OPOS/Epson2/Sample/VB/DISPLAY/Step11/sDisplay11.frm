...
Begin VB.Form Step11 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Step 11 Obtains the statistics of the device."
   ClientHeight    =   5025
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6030
   ...
   Begin OposLineDisplay_CCOCtl.OPOSLineDisplay OPOSLineDisplay1 
      Left            =   360
      OleObjectBlob   =   "sDisplay11.frx":0000
      Top             =   4080
   End
End
Attribute VB_Name = "Step11"
...
Private Sub cmdRetrieveSt_Click()
    ...
    With OPOSLineDisplay1
        ...
        If (.ResultCode <> OPOS_SUCCESS) Then
            ...
            MsgBox strErrMsg, vbOKOnly + vbExclamation, "Display"
            Exit Sub
        End If
    End With
