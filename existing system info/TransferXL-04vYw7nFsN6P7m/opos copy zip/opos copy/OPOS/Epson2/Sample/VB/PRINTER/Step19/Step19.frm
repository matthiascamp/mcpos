...
Begin VB.Form Step19 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Step 19 Multi-tone Print"
   ClientHeight    =   4530
   ClientLeft      =   3045
   ClientTop       =   3330
   ClientWidth     =   7365
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox Combo1 
            Height          =   300
            ItemData        =   "Step19.frx":0000
            Left            =   210
            List            =   "Step19.frx":001B
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   120
      Width           =   3330
      Begin VB.CommandButton cmdMultiTonePrint 
         Caption         =   "Multi-tone Print"
         Height          =   375
         Left            =   360
         TabIndex        =   18
         Top             =   2640
   ...
   Begin OposPOSPrinter_CCOCtl.OPOSPOSPrinter OPOSPOSPrinter1 
      Left            =   5160
      OleObjectBlob   =   "Step19.frx":0111
      Top             =   3840
   End
End
Attribute VB_Name = "Step19"
...
Private Sub cmdMultiTonePrint_Click()
    Dim pData As Long
...
' Initialization
    ESC = Chr(&H1B)
    fDate = Format(Now, "mmm dd, yyyy  AM/PM h:mm")
...
'Make messages for the each event information.
    ...
    With OPOSPOSPrinter1
        ...
        .DirectIO PTR_DI_SET_BITMAP_PRINTING_TYPE, pData, pString
        If (.ResultCode = OPOS_SUCCESS) Then
            .DirectIO PTR_DI_SET_BITMAP_PRINTING_TYPE, PTR_DI_BITMAP_PRINTING_NORMAL, pString
        Else
            cmdMultiTonePrint.Enabled = False
        End If
