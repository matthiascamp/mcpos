...
Begin VB.Form Form5 
   Caption         =   "Step 5 Retrieve Device Statistics"
   ClientHeight    =   9075
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10905
   ...
   Begin VB.Frame FrameElectronicJournal 
      ...
      Begin VB.Frame Frame4 
         ...
         Top             =   3720
         Width           =   4455
         Begin VB.TextBox StatisticsParamEJEdit 
            Height          =   375
            Left            =   600
            TabIndex        =   29
            Text            =   "ModelName"
            ...
            Width           =   3015
         End
         Begin VB.CommandButton RetrieveStatisticsEJButton 
   ...
   Begin VB.Frame Frame11 
      ...
      Top             =   360
      Width           =   10215
      Begin VB.TextBox StatisticsParamPtrEdit 
         Height          =   375
         Left            =   5760
         TabIndex        =   28
         Text            =   "ModelName"
         ...
         Width           =   3615
      End
      Begin VB.CommandButton RetrieveStatisticsPtrButton 
         Caption         =   "RetrieveStatisticsPtr"
         Height          =   375
         Left            =   6360
         TabIndex        =   27
         Top             =   240
...
Private Sub Form_Load()
    ...
    With OPOSPOSPrinter1
       ...
       .DeviceEnabled = True
        ...
        If .CapStatisticsReporting = True Then

            StatisticsParam = "ModelName,HoursPoweredCount"
    
            If .CapRecPresent = True Then
                StatisticsParam = StatisticsParam + ",ReceiptCharacterPrintedCount"
            End If
            
            StatisticsParamPtrEdit.Text = StatisticsParam
        Else
            StatisticsParamPtrEdit.Enabled = False
            RetrieveStatisticsPtrButton.Enabled = False
        End If
    ...
    With OPOSElectronicJournal1
        ...
        If .CapStatisticsReporting = True Then
            ...
            StatisticsParam = "ModelName,HoursPoweredCount,WriteCount,EraseCount"
            StatisticsParamEJEdit.Text = StatisticsParam
        Else
            StatisticsParamEJEdit.Enabled = False
            RetrieveStatisticsEJButton.Enabled = False
        End If
...
Private Sub OPOSElectronicJournal1_OutputCompleteEvent(ByVal OutputID As Long)
    ...
    OutputCompleteEventDlg.Caption = "EJSample_Step5"
...
Private Sub OPOSElectronicJournal1_StatusUpdateEvent(ByVal Data As Long)
    ...
    If Data = EJ_SUE_MEDIUM_NEAR_FULL Then
        MsgBox "ElectronicJournal Medium Near Full.", vbOKOnly, "EJSample_Step5"
    End If
...
Private Sub OPOSPOSPrinter1_StatusUpdateEvent(ByVal Data As Long)
    ...
    If Data = PTR_SUE_REC_NEAREMPTY Then
        MsgBox "Receipt Station Paper Near End.", vbOKOnly, "EJSample_Step5"
...
Private Sub RetrieveStatisticsEJButton_Click()
    ...
    strParam = StatisticsParamEJEdit.Text
    strErrMsg = ""
    strFindXMLPath = ""
    ...
    strXMLPath = App.Path + "\SampleEJ.xml"
    'Delete XML file.
    ...
    Step5Browser.SetLoadFileName ("\SampleEJ.xml")
...
Private Sub RetrieveStatisticsPtrButton_Click()
    ...
    strParam = StatisticsParamPtrEdit.Text
    strErrMsg = ""
    strFindXMLPath = ""
    ...
    strXMLPath = App.Path + "\SamplePtr.xml"
    'Delete XML file.
    strFindXMLPath = Dir(strXMLPath)
    If strFindXMLPath <> "" Then
        Kill (strXMLPath)
    ...
    Step5Browser.SetLoadFileName ("\SamplePtr.xml")
