...
Begin VB.Form Step12 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Step 12 Rotated-Prints Bitmaps and Barcodes"
   ClientHeight    =   4530
   ClientLeft      =   3045
   ClientTop       =   3330
   ClientWidth     =   7365
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox Combo1 
            Height          =   300
            ItemData        =   "Step12.frx":0000
            Left            =   210
            List            =   "Step12.frx":001B
   ...
   Begin OposPOSPrinter_CCOCtl.OPOSPOSPrinter OPOSPOSPrinter1 
      Left            =   5280
      OleObjectBlob   =   "Step12.frx":0111
      Top             =   3840
   End
End
Attribute VB_Name = "Step12"
