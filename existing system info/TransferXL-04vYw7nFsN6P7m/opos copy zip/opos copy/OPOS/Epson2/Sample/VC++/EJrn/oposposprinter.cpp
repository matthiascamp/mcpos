...
BOOL COPOSPOSPrinter::GetCapCompareFirmwareVersion()
{
	BOOL result;
...
BOOL COPOSPOSPrinter::GetCapUpdateFirmware()
{
	BOOL result;
...
long COPOSPOSPrinter::CompareFirmwareVersion(LPCTSTR FirmwareFileName, long* pResult)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_PI4;
...
long COPOSPOSPrinter::UpdateFirmware(LPCTSTR FirmwareFileName)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR;
...
BOOL COPOSPOSPrinter::GetCapConcurrentPageMode()
{
	BOOL result;
...
BOOL COPOSPOSPrinter::GetCapRecPageMode()
{
	BOOL result;
...
BOOL COPOSPOSPrinter::GetCapSlpPageMode()
{
	BOOL result;
...
CString COPOSPOSPrinter::GetPageModeArea()
{
	CString result;
...
long COPOSPOSPrinter::GetPageModeDescriptor()
{
	long result;
...
long COPOSPOSPrinter::GetPageModeHorizontalPosition()
{
	long result;
...
void COPOSPOSPrinter::SetPageModeHorizontalPosition(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CString COPOSPOSPrinter::GetPageModePrintArea()
{
	CString result;
...
void COPOSPOSPrinter::SetPageModePrintArea(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
long COPOSPOSPrinter::GetPageModePrintDirection()
{
	long result;
...
void COPOSPOSPrinter::SetPageModePrintDirection(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long COPOSPOSPrinter::GetPageModeStation()
{
	long result;
...
void COPOSPOSPrinter::SetPageModeStation(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long COPOSPOSPrinter::GetPageModeVerticalPosition()
{
	long result;
...
void COPOSPOSPrinter::SetPageModeVerticalPosition(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long COPOSPOSPrinter::ClearPrintArea()
{
	long result;
...
long COPOSPOSPrinter::PageModePrint(long Control)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
long COPOSPOSPrinter::PrintMemoryBitmap(long Station, LPCTSTR Data, long Type, long Width, long Alignment)
{
	long result;
	static BYTE parms[] =
...
long COPOSPOSPrinter::GetCapRecRuledLine()
{
	long result;
...
long COPOSPOSPrinter::GetCapSlpRuledLine()
{
	long result;
...
long COPOSPOSPrinter::DrawRuledLine(long Station, LPCTSTR PositionList, long LineDirection, long LineWidth, long LineStyle, long LineColor)
{
	long result;
	static BYTE parms[] =
